...
<head>
    ...
    <link href="http://localhost/jktrans/asset/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
...
<div class="row">
                        ...
                        <form method="post" action="input-aksi.php">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="sp" id="sp">
                            </div>
                            <div class="form-group">
                                <label class="text-dark" for="colli">Colli</label>
                                <input class="form-control" type="number" name="colli" id="colli">
                            </div>
                            <div class="form-group">
    ...
    <!-- Page level plugins -->
    <script src="http://localhost/jktrans/asset/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="http://localhost/jktrans/asset/vendor/datatables/dataTables.bootstrap4.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="http://localhost/jktrans/asset/js/demo/datatables-demo.js"></script>
